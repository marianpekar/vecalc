...
vector1Folder.add(args, 'v1x', -100, 100).name("X").step(0.001).onChange(draw);
vector1Folder.add(args, 'v1y', -100, 100).name("Y").step(0.001).onChange(draw);
vector1Folder.add(args, 'v1z', -100, 100).name("Z").step(0.001).onChange(draw);
vector1Folder.add(args, 't', -100, 100).name("t").step(0.001).onChange(draw);
vector1Folder.open();

let vector2Folder = gui.addFolder("v2u")
vector2Folder.add(args, 'v2x', -100, 100).name("X").step(0.001).onChange(draw);
vector2Folder.add(args, 'v2y', -100, 100).name("Y").step(0.001).onChange(draw);
vector2Folder.add(args, 'v2z', -100, 100).name("Z").step(0.001).onChange(draw);
vector2Folder.add(args, 'u', -100, 100).name("u").step(0.001).onChange(draw);
vector2Folder.open();
